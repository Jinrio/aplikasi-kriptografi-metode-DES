...
<form name="input-data"action="inputdesk.php"method="post">
<table align="center">
                        <div class="body">                            
                            <div class="row clearfix">
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        <div class="form-line">
                                            <textarea name="nama"rows="4" class="form-control no-resize" placeholder="masukkan data..."></textarea>
                                        </div>
                                    </div>
                                </div>
                            </div>
<input type="submit" value="Deskripsi" name="submit"  class="btn bg-blue-grey btn-block btn-lg waves-effect" style="border-radius: 0; box-shadow: 0 2px 2px #858585;"/>
<p></p>
<a href="data_desk.php"><p>Lihat Data Deskripsi</p></a>
</div>
</table>
</form>
