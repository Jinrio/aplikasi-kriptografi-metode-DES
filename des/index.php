...
<!-- START Content -->
 ...
 <div class="body">
 <form  method="POST">
 <a  href="enkrip.php"><button type="button" class="btn bg-blue-grey btn-block btn-lg waves-effect" style="border-radius: 0; box-shadow: 0 2px 2px #858585;" >ENKRIPSI DATA</button></a>
 <p></p>
 <p></p>
 <a href="deskrip.php"><button type="button" class="btn bg-blue-grey btn-block btn-lg waves-effect" style="border-radius: 0; box-shadow: 0 2px 2px #858585;" >DESKRIPSI DATA</button></a>
 </div>
 </div>
</form>
